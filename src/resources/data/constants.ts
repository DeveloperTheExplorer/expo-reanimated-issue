import { Platform, Dimensions, NativeModules, I18nManager, AccessibilityInfo, AccessibilityChangeEvent, EmitterSubscription } from 'react-native';
...
const constants = {
    ...
    /* Dimensions */
    removeDimensionsEventListener: (callback: EmitterSubscription) => {
        if (callback.remove) {
            callback.remove();
        }
    },
